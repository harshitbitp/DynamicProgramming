class EqualSumPartitionTabulation {
  
    public boolean canPartition(int[] arr) {
     return EqualSumPartitionPossible(arr,arr.length);
    }

    boolean isSubsetPossible(int arr[], int n, int sum) {
...
boolean EqualSumPartitionPossible(int arr[], int n) {
